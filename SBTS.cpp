...
void constructSol()
{
    ...
    //cout << "y ahora " << nb0Len << endl; 
}

void constructSol2()
{
     int selV;
     std::istringstream iss(initSol);
     std::vector<std::string> results(std::istream_iterator<std::string>{iss},
                                 std::istream_iterator<std::string>());
//cout << "con initSol " << nb0Len << endl;
     int i = 0;
     while(1)
     {
             if(nb0Len > 0)
             {
                       selV = atoi(results[i].c_str());
		       //cout << selV << endl; 
                       updateInfo(selV, 0, false, false);          
             }
             else
...
/*
       cout << "argc "<< argc << endl;
       cout << "lala "<< inFile << endl;
       cout << "lala "<< outFile << endl;
       cout << "lala "<< obj << endl;
       cout << "lala "<< tabuTenue << endl;
       cout << "lala "<< time_limit << endl;
       cout << "lala "<< initSol << endl;
*/	
       int maxSize = 0; 
       int runTimes = 1;
       int sucRuns = 0;
