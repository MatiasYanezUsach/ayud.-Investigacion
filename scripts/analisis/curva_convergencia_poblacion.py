...
BASE_DIR   = os.path.abspath(os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", ".."))  # raiz del repo
PRUEBA_DIR = os.path.join(BASE_DIR, "out", "prueba_poblacion")
OUT_DIR    = os.path.join(BASE_DIR, "reportes", "graficos", "convergencia")
...
def generar_excel():
    ...
    outfile = os.path.join(BASE_DIR, "reportes", "reporte_prueba_poblacion.xlsx")
    wb.save(outfile)
