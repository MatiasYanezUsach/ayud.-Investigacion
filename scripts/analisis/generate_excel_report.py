...
def count_instances():
    ...
    data/evolution contiene 36 archivos, pero scripts/linux/run_experiment.sh limita la evolución
    ...
    launcher = "scripts/linux/run_experiment.sh"
...
def generate_excel(group_num=None):
    ...
    if group_num is not None:
        excel_file = f"reportes/RESULTADOS_EXPERIMENTO_GRUPO{group_num}.xlsx"
    else:
        excel_file = "reportes/RESULTADOS_EXPERIMENTO.xlsx"
