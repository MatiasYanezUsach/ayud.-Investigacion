...
```batch
scripts\windows\run_experiment.bat 0 30   # Grupo 0: Sin CPLEX
scripts\windows\run_experiment.bat 2 30   # Grupo 2: 25%
scripts\windows\run_experiment.bat 3 30   # Grupo 3: 50%
scripts\windows\run_experiment.bat 4 30   # Grupo 4: 75%
scripts\windows\run_experiment.bat 5 30   # Grupo 5: 100%
```
...
2. **Reportes automáticos**: Después de cada grupo, se generará automáticamente:
   - `reportes/RESULTADOS_EXPERIMENTO_GRUPOX.xlsx`
   - `reportes/graficos/grupoX/` (8 gráficos PNG)
