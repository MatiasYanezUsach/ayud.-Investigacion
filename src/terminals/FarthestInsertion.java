...
public class FarthestInsertion extends GPNode {

    private static final long serialVersionUID = -2534468795456857335L;

    public String toString() { return "FarthestInsertion"; }
    ...
    public void eval(final EvolutionState state, final int thread,
        ...
        pdpd.setResult(Terminal.farthest_insertion(pdpd.getInstance().getPdpInstance()));
