...
public class FarthestNeighbor extends GPNode {

    private static final long serialVersionUID = -2534468795456857335L;

    public String toString() { return "FarthestNeighbor"; }
    ...
    public void eval(final EvolutionState state, final int thread,
        ...
        pdpd.setResult(Terminal.add_farthest_neighbor_last_node(pdpd.getInstance().getPdpInstance()));
