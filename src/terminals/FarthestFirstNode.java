...
public class FarthestFirstNode extends GPNode {

    private static final long serialVersionUID = -2534468795456857335L;

    public String toString() { return "FarthestFirstNode"; }
    ...
    public void eval(final EvolutionState state, final int thread,
        ...
        pdpd.setResult(Terminal.add_farthest_neighbor_first_node(pdpd.getInstance().getPdpInstance()));
